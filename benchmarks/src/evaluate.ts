...
export const PRIMERS: Record<string, string> = {
  ...
  'gcf': 'GCF: Positional format. Arrays declare fields in header (## name [count]{field1,field2}). Rows are @id followed by pipe-separated values in field order. Sections marked with ##.',
}
